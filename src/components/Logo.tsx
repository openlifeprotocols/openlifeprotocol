...
export function Logo(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg aria-hidden="true" viewBox="0 0 80 36" fill="none" {...props}>
      <LogomarkPaths />
      <text x="36" y="28" fontSize="24" fontWeight="bold" fill="#38BDF8" fontFamily="system-ui, -apple-system, sans-serif">OLP</text>
    </svg>
  )
}
