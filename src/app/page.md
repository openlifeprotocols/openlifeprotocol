...
{% quick-link title="Specification" icon="presets" href="/docs/specification-overview" description="Deep dive into the OLP specification and architecture." /%}
...
### Like OpenAPI, But for Life

| Aspect | OpenAPI | OLP |
|--------|---------|-----|
| What it standardizes | API contracts | Life & business processes |
| Generated from spec | Clients, servers, SDKs | Workflows, validators, tools |
| Adoption | 10,000+ tools | Emerging ecosystem |
| Network effect | API integration | Cross-system automation |
...
```bash
olp workflow create death-uk --jurisdiction england
olp validate
olp publish
```
...
The formal contract that defines how life and business processes work.

### Workflows Registry (Phase 3)
A GitHub-like registry where workflows are stored, versioned, and shared.

### SDKs (Phase 3)
Official packages for TypeScript, Python, Go, Java, PHP, .NET, and Rust.

### Conformance (Phase 4)
Certification levels ensuring systems implement OLP correctly.
...
{% quick-link title="Core Concepts" icon="plugins" href="/docs/core-concepts-overview" description="Actors, Events, Cases, Workflows, Tasks, Documents, and more." /%}

{% quick-link title="Specification" icon="presets" href="/docs/specification-overview" description="Full technical specification and architecture." /%}

{% quick-link title="Contributing" icon="plugins" href="/docs/contributing" description="Join the effort to standardize life processes." /%}
